...
from app.domain.receipt.exception.receipt_exception import FileValidationException
    ...
    async def validate_image(file: UploadFile):
        ...
        try:
            ...
            if file_size > FileValidator.MAX_FILE_SIZE:
                raise FileValidationException(
                    error_code=ReceiptErrorCode.FILE_TOO_LARGE,
            ...
            try:
                ...
                if width < FileValidator.MIN_IMAGE_SIZE[0] or height < FileValidator.MIN_IMAGE_SIZE[1]:
                    raise FileValidationException(
                        error_code=ReceiptErrorCode.INVALID_IMAGE_SIZE,
