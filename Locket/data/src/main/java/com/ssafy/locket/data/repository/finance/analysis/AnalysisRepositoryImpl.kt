package com.ssafy.locket.data.repository.finance.analysis
...
import com.ssafy.locket.data.network.response.finance.analysis.FeedbackResponse.Companion.toDomainModel
        ...
        return flow {
            ...
            when (result) {
                is ApiResponse.Success -> {
                    ...
                    Log.d("AnalysisRepository", "API 응답 성공: ${data}")
                    Log.d("AnalysisRepository", "JSON 변환: ${Gson().toJson(data)}") // JSON 형태로 출력
